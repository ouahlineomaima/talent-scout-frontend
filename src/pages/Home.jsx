...
export default function Home() {
    return (
        <div className='flex flex-row w-screen h-screen bg-white dark:bg-darkBg'>
            <div className="w-[55%] h-2/3 justify-start items-center gap-[2.438rem] flex  pl-4 pt-4 ">
                <div className="flex flex-col  gap-[2.5rem] ">
                    ...
                    <div className="justify-start items-start gap-[2.438rem] ss:inline-flex">
                        <button className='justify-center items-center bg-logoGreen w-[10rem] h-[4.125rem] text-center text-white dark:text-darkBg font-normal font-open-sans text-lg p-[0.75rem] rounded-lg'>Get started</button>
