...
export default function Home() {
    return (
        <div className='flex flex-col w-screen bg-white dark:bg-darkBg'>
            {/* Lnding page */}
            ...
            {/* Capabilities */}
            <div className="w-full h-max px-[1.875rem] flex-col justify-start items-center gap-[6.25rem] inline-flex">
                ...
                <div className="w-full  self-stretch justify-start items-start gap-[1rem] flex flex-col lg:flex-row ">
                    <div className="w-full flex-col justify-start items-start gap-[1.875rem] inline-flex">
                        <div className="w-full justify-center items-center gap-2.5 inline-flex  h-max">
                            <svg xmlns="http://www.w3.org/2000/svg" className='w-14 h-14 fill-darkBg dark:fill-white ' viewBox="0 0 56 56" >
                        ...
                        <div className="w-full text-darkBg dark:text-white text-base font-medium font-open-sans">Streamline your recruitment process with our advanced Applicant Tracking System (ATS) that effortlessly extracts resumes from Gmail applications. Our system evaluates each resume against your job descriptions, providing a comprehensive score that highlights the degree of compatibility. Spend less time sifting through resumes and more time focusing on the top candidates who best match your job requirements.</div>
                    </div>
                    <div className="w-full flex-col justify-start items-start gap-[1.875rem] inline-flex ">
                        <div className="w-full justify-center items-center gap-2.5 inline-flex  h-max">
                            <svg xmlns="http://www.w3.org/2000/svg" className='w-14 h-16 fill-darkBg dark:fill-white ' viewBox="0 0 56 64" >
                        ...
                        <div className="w-full text-darkBg dark:text-white text-base font-medium font-open-sans">Say goodbye to the hassle of coordinating schedules manually. Our website simplifies the interview scheduling process by allowing recruiters to effortlessly set up online interviews. With just a few clicks, you can send interview invitations, manage responses, and ensure a seamless scheduling experience. Save time and keep the recruitment process moving smoothly.</div>
                    </div>
                    <div className="w-full flex-col justify-start items-start gap-[1.875rem] inline-flex">
                        <div className="w-full justify-center items-center gap-2.5 inline-flex  h-max">
                            
                            <svg xmlns="http://www.w3.org/2000/svg" className='w-14 h-[4.667rem] fill-darkBg dark:fill-white ' viewBox="0 0 56 76" >
                        ...
                        <div className="w-full text-darkBg dark:text-white text-base font-medium font-open-sans">Enhance your candidate engagement with our automated email system. Communicate efficiently with applicants by sending personalized acceptance or rejection emails. Track applicant statuses easily with customizable labels such as "Contacted," "Interview Passed," and "Rejected." Keep everyone in the loop and maintain a clear overview of your recruitment pipeline.</div>
                    </div>
                    <div className="w-full flex-col justify-start items-start gap-[1.875rem] inline-flex ">
                        <div className="w-full justify-center items-center gap-2.5 inline-flex  h-max">
                        ...
                        <div className="w-full text-darkBg dark:text-white text-base font-medium font-open-sans">Make data-driven decisions with our dynamic ranking system. Our website not only scores resumes but also provides a ranked list of applicants based on their compatibility with the job description. This feature empowers recruiters to focus on the most promising candidates first, ensuring that your time and resources are invested where they matter most. Stay ahead in the competitive hiring landscape with smart and efficient candidate prioritization.</div>
                    </div>
                </div>
            </div>
