...
export default function Profile() {
    ...
    <div className="flex flex-row flex-wrap w-[80%] gap-8">
        <div className="flex flex-col justify-start w-1/2">
            <h4 className="capitalize text-base text-darkBg dark:text-white">First name</h4>
            <h4 className="capitalize text-base text-darkBg dark:text-white border border-gray-500 bg-gray-300">{user.firstname}</h4>
        </div>

        <div className="flex flex-col justify-start w-1/2">
            <h4 className="capitalize text-base text-darkBg dark:text-white">Last name</h4>
            <h4 className="capitalize text-base text-darkBg dark:text-white border border-gray-500 bg-gray-300">{user.lastname}</h4>
        </div>

        <div className="flex flex-col justify-start w-full">
            <h4 className="capitalize text-base text-darkBg dark:text-white">Tracked email</h4>
            <div className="flex flex-row gap-2">
                <h4 className="capitalize text-base text-darkBg dark:text-white border border-gray-500 bg-gray-300">{user.email}</h4>
                <button
                    type='button'
